...
This is deliberately not a sandbox: Runtime.evaluate, Storage.setCookies and
other allowed methods can still change page or profile state. Internal, scoped
tools retain their own policies.
"""
...
_BLOCKED_METHODS = frozenset({
    ...
    # Page.setDownloadBehavior is a deprecated alias that still changes the
    # browser context through BrowserHandler::DoSetDownloadBehavior.
    "Page.close", "Page.setDownloadBehavior",
