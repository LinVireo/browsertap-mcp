...
not a separate tool effect. Token ACL hardening is a local security change.
Unknown dynamically registered tools receive the
...
TOOL_EFFECTS: dict[str, tuple[bool, bool, bool, bool]] = {
    ...
    # Diagnosis can tighten an existing Windows token file's ACL.
    "get_setup_status": (False, False, True, True),
